...
public class MiniMapControls : MonoBehaviour
{
    ...
    public bool _toggleMapRotation;
    //add this
    ...
    private void ToggleRotation()
    {
        ...
        if (_toggleMapRotation == true)
        {
            _renderCamera.GetComponent<MiniMap>().enabled = false;
            _renderCamera.GetComponent<MiniMapWithRotation>().enabled = true;

        }
        else if(_toggleMapRotation == false)
        {
            _renderCamera.GetComponent<MiniMap>().enabled = true;
            _renderCamera.GetComponent<MiniMapWithRotation>().enabled = false;
